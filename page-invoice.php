...
function tt_do_title() {
	...
	echo '<div class="hours-head"><span class="hours-user">User</span><span class="hours-work-date">Work Date</span><span class="hours-client">Client</span><span class="user-total-hours">User Hours</span><span class="hours-work-done">Work Done</span><span class="hours-hours-worked">Hours</span></div>';
...
function short_post() {
	...
	echo '<div class="tt-row ' . $class_separator . '">';
